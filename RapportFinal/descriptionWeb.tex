...
On affiche la partition et la tablature qui lui correspond. La note (dans la zone grise à côté du nom de la partition) est calculée à partir des notes des commentaires que tous les utilisateurs peuvent écrire. \\
Si il n'y a pas de commentaires correspondants, la note est fixée à 0. \\

\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{tab}
\caption{Affichage d'une tablature}
\end{figure}
